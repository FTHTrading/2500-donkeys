...
The paper is archived on Zenodo with a DOI. The source code, contracts, and tests are open on GitHub. Everything is independently verifiable.
...
- **Character count:** ~1,050 (well within LinkedIn's 3,000 limit)
- **Tone:** Professional, factual, no hype
- **CTA:** Implicit — the links are the call to action
